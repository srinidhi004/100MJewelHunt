...
function setup() {
  ...
  digbutton=createSprite(100,1000,40,25);
  digbutton.addImage(digbuttonimg);
  digbutton.visible=false;
  flag=createSprite(100,1000,40,25);
   ...
   farmbg.visible=true;
    ...
    if(frameCount>2500 || frameCount===4000 && frameCount<4001){
     ...
     // runner.collide(ig4);
      ...
      if(frameCount===4050 && frameCount<4100 ){
        digbutton.visible=true;
        desertbg.visible=true;
        if(mousePressedOver(digbutton)){
          digImg.visible=true;
          if(digImg.visible===true){
...
function reset(){
 ...
 function rocks(){
  ...
  function cactus(){
    if(frameCount % 60 === 0){
      cactus= createSprite(1300,550,50,200);
      cactus.addImage(cactusimg);
      cactus.velocityX=-8;
      cactus.scale=0.1;
      cactusgroup.add(cactus);
      runner.depth= cactus.depth;
    }
  }
